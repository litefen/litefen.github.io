...
//    约定，定义所有的url末尾都要有斜杆
        ...
        }else if (strlen(trim(Utils::getCdnUrl(0))) > 0){
...
//            echo $imageSrc."|".$options->rootUrl;
            ...
            //如果时间大于了2021,使用第二个参数
            if (strpos($imageSrc,CDN_Config::SPECIAL_MODE_NUM) !== false){
...
//        $color = array( "info", "dark", "success", "black", "warning", "primary", "danger");
     ...
     * @return string
     */
    public static function getTimelineHeader($content,$type,$index,$isRandom = true,$color = "light"){
        if ($isRandom){
