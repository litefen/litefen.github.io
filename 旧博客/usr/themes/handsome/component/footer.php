      ...
      <script type="text/template" id="tmpl-customizer">
          <div class="settings panel panel-default setting_body_panel" aria-hidden="true">
              <button class="rightSettingBtn fix-padding btn btn-default pos-abt border-radius-half-left"
                  ...
                  _me("外观设置") ?>"
                      data-toggle-class=".settings=active, .settings-icon=animate-spin-span">
...
<!--              <i class="fontello fontello-chevron-circle-up" aria-hidden="true"></i>-->
      ...
      <div class="tag_toc_body hide">
          <div class="tocify-mobile-panel panel panel-default
              setting_body_panel"
               aria-hidden="true">
...
//
//        $autoPlay = false;
//        if($this->options->playerSetting != "" && in_array('autoPlay', Utils::checkArray($this->options->playerSetting))){
//            $autoPlay = true;
//        }
//
//
