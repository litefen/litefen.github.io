...
function choseVditor($content)
{
    ...
    $cssUrl = $options->pluginUrl . '/Handsome/assets/css/index.min.css?v=8.0.0';
    $jsUrl = $options->pluginUrl . '/Handsome/assets/js/index.min.js?v=8.0.0';
        ...
        $(document).ready(function () {
            ...
            function promptDialog(dialogContent) {
                ...
                function _click(_cancel) {
                    ...
                    if (!_cancel) {
                        console.log(getRet());
                        vditor.insertValue(getRet(),true);
                    }
