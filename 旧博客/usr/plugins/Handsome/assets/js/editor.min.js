        ...
        if ($("#wmd-button-row").length >0){
            ...
            $(document).on('click', '#wmd-hplayer-button', function() {
                ...
                $('body').append(
                    ...
                    '<div>'+
                    '<p><b>插入音乐</b></p>'+
                    '<p>请在下方的输入框内输入要插入的音乐地址 <p style="color: #ff0012">支持歌单地址，支持多种类型混合</p> <a target="_blank" href="https://handsome.ihewro.com/#/functions?id=%e6%96%87%e7%ab%a0%e5%86%85%e6%8f%92%e5%85%a5%e9%9f%b3%e4%b9%90">使用文档</a>'+
